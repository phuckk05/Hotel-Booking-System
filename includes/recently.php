    ...
    <div class="space-y-16">
        <div
            ...
            <div class="relative w-full md:w-auto md:flex-shrink-0">
                <img src="assets/images/bg.webp" alt="Thanh Tin Hotel Dalat"
                    class="rounded-lg w-full md:w-56 h-48 object-cover" />
            </div>

            <div class="flex-1 space-y-2 w-full">
                <div>
                    <h3 class="text-xl font-bold text-gray-800">Thanh Tin Hotel Dalat</h3>
                    <p class="text-gray-500 text-sm">Nhà khách</p>
                </div>
                <p class="text-gray-600 text-sm">Đà Lạt, cách Trung tâm thành phố 2.4 km</p>
                ...
                <div class="flex items-center text-gray-500 text-sm space-x-4">
                    <div class="flex items-center space-x-1">
                        <svg xmlns="assets/images/bg.webp" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span class="mr-4">22.08.25 – 17.09.25</span>
                    </div>
                    <div class="flex items-center space-x-1">
                        <svg xmlns="assets/images/bg.webp" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
            ...
            <div class="flex flex-col items-center md:items-end w-full md:w-auto mt-4 md:mt-0">
                ...
                <button
                    ...
                    <span>Xem giá</span>
                    <svg xmlns="assets/images/bg.webp" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <button class="mt-6 text-blue-600 hover:text-blue-800 text-sm font-semibold">
            Xóa các mục xem gần đây
        </button>
    </div>