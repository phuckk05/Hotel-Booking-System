...
<div class="max-w-7xl mx-auto pt-4 pb-4 space-y-4">
    ...
    <!-- Thông báo kết quả -->
    <p class="text-sm text-gray-600 py-2">Chúng tôi đã tìm thấy <b>200</b> khách sạn từ <b>102</b> trang</p>
        ...
        <div
            ...
            <div class="flex-1 p-4 flex flex-col justify-between">
                ...
                <div
                    ...
                    <div>
                        <div class="text-xs text-red-600 font-bold mb-1">Giá thấp nhất của chúng tôi</div>
