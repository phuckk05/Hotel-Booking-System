...
<div>
    ...
    <div class="<?php echo $location ? '' : 'hidden' ?>">
        <?php include 'includes/result.php'; ?>
    </div>
    <!-- Các địa điểm được đề xuất -->
    <h1 class="<?php echo $location ? 'hidden' : '' ?> text-2xl mb-4 font-bold text-center mt-6">Đề xuất cho bạn</h1>
    <div class="<?php echo $location ? 'hidden' : '' ?> grid grid-cols-2 sm:grid-cols-4 g p-4 gap-16 max-w-7xl mx-auto">
        <?php for ($i = 0; $i < 8; $i++): ?>
            <div
                ...
                <div class="py-2">
                    <h3 class="text-sm font-bold mb-2 text-gray-800">Khách sạn đẹp tại trung tâm</h3>
                </div>
                ...
                <div class="w-full overflow-hidden pb-4">
                    <h1 class="text-red-700 text-xl font-bold whitespace-nowrap truncate">VND 1,000,000</h1>
                </div>
            </div>
        <?php endfor; ?>
    </div>
    ...
    <!-- Khám phá -->
    <div class="<?php echo $location ? 'hidden' : '' ?> max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            <?php for ($i = 1; $i <= 5; $i++): ?>
                <div
                    class="bg-white rounded-lg shadow hover:shadow-lg transition <?php echo $i % 2 == 0 ? 'mt-0 md:mt-20' : 'mb-0 md:mb-20'; ?>">
